...
public class LoginAdminJF extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("QUẢN TRỊ HỆ THỐNG");

        jLabel1.setText("Tên đăng nhập");

        jButton2.setText("Đăng nhập nhân viên");
        ...
        jLabel4.setText("Trang đăng nhập dành cho quản trị viên");
 ...
 private void moveToMainForm() {
    ...
    public boolean loginAdmin(String username, String password) {
        try {
            ...
            PreparedStatement countPst = sqlConn.prepareStatement("SELECT COUNT(*) AS count FROM admin WHERE username = ? AND password = ?");
            ...
            if (count == 1) {
                ...
                PreparedStatement selectPst = sqlConn.prepareStatement("SELECT id, username, name FROM admin WHERE username = ? AND password = ?");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(LoginAdminJF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new LoginAdminJF().setVisible(true);
            }
        });
    }
