 ...
 * @author doanq
 */
public class EditPasswordEmployeeJP extends javax.swing.JPanel {

    /**
     * Creates new form ChangePasswordEmployeeJP
     */
    public EditPasswordEmployeeJP() {
        initComponents();
        loadScreen();
    }
    ...
    private void updatePassword(String password, String username) {
        ...
        try {
            ...
            String sql = "UPDATE employee SET password = ? WHERE username = ?"; // Thêm điều kiện WHERE phù hợp
